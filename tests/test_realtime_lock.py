...
def test_realtime_editing_lock(app, mock_db):
    ...
    """
    # Patch the editing_locks dictionary more aggressively
    with patch('website.web.sockets.editing_locks', {}) as mock_locks:
        ...
        # create SocketIO clients with the correct headers from the http client sessions
        ...
        if not received:
            # If no events received, the test might be failing due to socket setup
